    ...
    return (
        <Link
            ...
            className={`flex items-center gap-2.5 pl-9 pr-3 py-2 rounded-xl text-[12.5px] font-medium transition-all duration-150
                ${isActive ? "bg-blue-600 text-white shadow-sm shadow-blue-500/20" : "text-gray-500 hover:bg-gray-100 hover:text-gray-900"}`}
        >
        ...
        <Sidebar>
            ...
            <SidebarFooter className="p-0">
                ...
                <div className="px-3 py-3 space-y-0.5">
                    ...
                    >
                        <div className="h-7 w-7 rounded-lg bg-gray-100 group-hover:bg-red-100 flex items-center justify-center shrink-0">
