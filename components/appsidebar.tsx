...
const items: Record<string, NavItem[]> = {
    admin: [
        { title: "Home", url: "/admin/dashboard", icon: LayoutDashboard, role: "admin" },
        { title: "Hostels", url: "/admin/hostels", icon: Building2, role: "admin" },
        { title: "Rooms", url: "/admin/hostels/rooms", icon: Bed, role: "admin" },
        { title: "Bookings", url: "/admin/bookings", icon: Calendar, role: "admin" },
        { title: "Payments", url: "/admin/payments", icon: CreditCard, role: "admin" },
        { title: "Staff", url: "/admin/salaries", icon: DollarSign, role: "admin" },
        { title: "Warden", url: "/admin/warden-salaries", icon: Users, role: "admin" },
        { title: "Users", url: "/admin/users-records", icon: Users, role: "admin" },
        { title: "Insights", url: "/admin/reports", icon: FileText, role: "admin" },
        { title: "Leaves", url: "/admin/leaves", icon: Plane, role: "admin" },
        { title: "Search", url: "/admin/audit", icon: Search, role: "admin" },
        { title: "Complaints", url: "/admin/complaints", icon: MessageSquare, role: "admin" },
        { title: "Notices", url: "/admin/notices", icon: Megaphone, role: "admin" },
        { title: "Expenses", url: "/admin/expenses", icon: DollarSign, role: "admin" },
        { title: "Mess", url: "/admin/mess", icon: Utensils, role: "admin" },
        { title: "Profile", url: "/admin/profile", icon: User, role: "admin" },
    ],
    warden: [
        { title: "Dashboard", url: "/warden", icon: LayoutDashboard, role: "warden" },
        { title: "Hostel", url: "/warden/hostels", icon: Building2, role: "warden" },
        ...
        { title: "Notices", url: "/warden/notices", icon: Megaphone, role: "warden" },
        { title: "Expenses", url: "/warden/expenses", icon: DollarSign, role: "warden" },
        { title: "Mess", url: "/warden/mess", icon: Utensils, role: "warden" },
        { title: "Profile", url: "/warden/profile", icon: User, role: "warden" },
    ],
    guest: [
        ...
        { title: "Mess", url: "/guest/mess", icon: Utensils, role: "guest" },
        { title: "Support", url: "/guest/support", icon: LifeBuoy, role: "guest" },
    ...
    staff: [
        ...
        { title: "Profile", url: "/staff/profile", icon: User, role: "staff" },
    ],
}
