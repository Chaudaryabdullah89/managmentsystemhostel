                    ...
                    if (emailAddresses.length > 0) {
                        ...
                        const bodyHtml = `
                          ...
                          <p style="margin:0 0 16px; font-size:14px; color:#4b5563;">
                            A new notice has been published by Mubarak Group of Hostels (MGH) management.
                          </p>
                        ...
                        const html = buildEmailTemplate({
                            ...
                            subtitle: hostelId ? 'Important update for your hostel' : 'Mubarak Group of Hostels @ Network Level',
                            bodyHtml,
                        });
