                ...
                <CardContent className="p-0">
                    <Table>
                        ...
                        <TableBody className="divide-y">
                            {payments.map((p) => (
                                <TableRow key={p.id} className="hover:bg-gray-50 dark:hover:bg-muted/5 dark:bg-muted/10 transition-colors">
                                    ...
                                    <TableCell className="px-6 py-4 text-sm font-bold text-gray-900 dark:text-foreground">
