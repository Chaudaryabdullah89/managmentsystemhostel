                                    ...
                                    {isStaffLike && (
                                        <>
                                            ...
                                            {formData.role === "WARDEN" && (
                                                <div className="space-y-6 pt-4 md:col-span-2 bg-gray-50 dark:bg-muted/10/50 dark:bg-background p-6 rounded-3xl border border-gray-100 dark:border-border">
