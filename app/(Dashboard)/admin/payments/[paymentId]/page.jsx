...
const PaymentApprovalDetailPage = () => {
    ...
    if (!payment) return (
        <div className="flex flex-col items-center justify-center min-h-screen p-20 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">Payment Not Found</h3>
            <p className="text-gray-400 dark:text-muted-foreground font-bold text-[10px] uppercase tracking-widest mt-2">The requested payment does not exist in the system.</p>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <h1 className="text-base font-bold text-gray-900 dark:text-foreground tracking-tight uppercase">Payment Review</h1>
                                <div className="flex items-center gap-2">
                                    <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">ID: {paymentId.slice(-12).toUpperCase()}</span>
                                    {isGuestNotification && (
                            ...
                            <DialogContent className="max-w-md rounded-2xl border-none shadow-2xl p-0 overflow-hidden">
                                ...
                                <div className="p-8 bg-white dark:bg-card space-y-5">
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 dark:text-muted-foreground ml-1">Rejection Reason</Label>
                                        <Textarea
                    ...
                    <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 relative overflow-hidden shadow-sm">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-[0.3em] mb-2">Payment Amount</span>
                            ...
                            <div className="flex flex-col items-start md:items-end gap-3 shrink-0">
                                ...
                                <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest bg-gray-50 dark:bg-muted/10 px-4 py-2 rounded-xl border border-gray-100 dark:border-border">
                                    <Clock className="h-3 w-3" /> {payment.date || payment.createdAt ? format(new Date(payment.date || payment.createdAt), 'MMM dd, yyyy') : '—'}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-gray-100 dark:border-border">
                            {[
                                { label: 'Date', value: payment.date || payment.createdAt ? format(new Date(payment.date || payment.createdAt), 'MMMM yyyy') : '—', icon: Calendar, sub: payment.date || payment.createdAt ? format(new Date(payment.date || payment.createdAt), 'MMM dd, yyyy') : '—' },
                                ...
                                <div key={i} className="flex flex-col gap-2 group">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">{item.label}</span>
                                    </div>
                                    <div className="pl-0.5">
                                        <p className="text-sm font-bold text-gray-900 dark:text-foreground uppercase tracking-wide">{item.value}</p>
                    ...
                    {payment.receiptUrl ? (
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm space-y-6 group/proof overflow-hidden">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <h3 className="text-sm font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">Payment Receipt</h3>
                                        <span className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-[0.2em]">Submitted verification image</span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm flex items-center justify-center py-20 group">
                            <div className="text-center">
                                ...
                                <h4 className="text-base font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">No Receipt Attached</h4>
                                <p className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest mt-2 max-w-[260px] leading-relaxed mx-auto">This payment was submitted without an attached image.</p>
                            </div>
                        </div>
                    )}
                                ...
                                <div className="p-5 bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-600/20 group-hover:scale-[1.01] transition-transform duration-300">
                                    ...
                                    <div className="flex items-center justify-between pt-3 border-t border-white/10">
                                        ...
                                        {payment.Booking?.Room?.floor && (
                                            <Badge className="bg-white dark:bg-card/20 text-white border-none rounded-lg px-2 py-0.5 text-[9px] font-bold uppercase transition-all">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-indigo-600 text-white rounded-2xl p-8 shadow-2xl shadow-indigo-600/20 relative overflow-hidden group">
                        ...
                        <div className="space-y-6">
                            ...
                            {payment.bookingId && (
                                <Link href={`/admin/bookings/${payment.bookingId}`}>
                                    <Button className="w-full h-11 bg-white dark:bg-card/10 border border-white/20 hover:bg-white dark:bg-card hover:text-indigo-600 text-white font-bold text-[10px] uppercase tracking-widest rounded-xl transition-all mt-2 shadow-md">
                    ...
                    <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-6 shadow-sm space-y-3">
                        <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 dark:text-muted-foreground mb-4">Actions</h3>
                        <Button
