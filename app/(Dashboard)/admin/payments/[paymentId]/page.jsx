    ...
    try {
      await updatePayment.mutateAsync({
        ...
        notes:
          status === "REJECTED"
            ? rejectionReason
            : payment.notes || "Payment verified and approved.",
      });
      toast.success(
        status === "PAID"
  ...
  if (!payment)
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-20 text-center">
        ...
        <h3 className="text-xl font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">
          Payment Not Found
        </h3>
        <p className="text-gray-400 dark:text-muted-foreground font-bold text-[10px] uppercase tracking-widest mt-2">
          The requested payment does not exist in the system.
        </p>
        <Button
          onClick={() => router.back()}
          variant="outline"
          className="mt-8 rounded-xl h-10 px-8 font-bold uppercase tracking-widest text-[9px]"
        >
          Go Back
        </Button>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-background pb-32 font-sans tracking-tight">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">
                    ID: {paymentId.slice(-12).toUpperCase()}
                  </span>
                  {isGuestNotification && (
                    <Badge className="bg-indigo-50 text-indigo-700 border border-indigo-100 text-[8px] px-2 py-0 ml-1">
                      Guest Entry
                    </Badge>
                  )}
                </div>
      ...
      <main className="max-w-[1600px] mx-auto px-8 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 relative overflow-hidden shadow-sm">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-[0.3em] mb-2">
                    Payment Amount
                  </span>
              ...
              <div className="flex flex-col items-start md:items-end gap-3 shrink-0">
                <Badge
                  variant="outline"
                  className={`${getStatusStyle(payment.status)} px-5 py-2 rounded-xl text-[10px] font-bold uppercase tracking-[0.15em] border`}
                >
                  {payment.status}
                </Badge>
                <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest bg-gray-50 dark:bg-muted/10 px-4 py-2 rounded-xl border border-gray-100 dark:border-border">
          ...
          {/* Proof of Payment */}
          {payment.receiptUrl ? (
            <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm space-y-6 group/proof overflow-hidden">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <h3 className="text-sm font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">
                      Payment Receipt
                    </h3>
                    <span className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-[0.2em]">
                ...
                <Link href={payment.receiptUrl} target="_blank">
                  <Button
                    variant="outline"
                    className="rounded-xl h-9 px-5 font-bold uppercase text-[9px] tracking-widest group/btn hover:border-indigo-200 hover:text-indigo-600"
                  >
                    Open Full Image{" "}
                    <ExternalLink className="h-3.5 w-3.5 ml-2 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                  </Button>
                </Link>
              </div>

              <div className="aspect-[16/10] bg-gray-50 dark:bg-muted/10 rounded-2xl border-2 border-dashed border-gray-200 dark:border-border overflow-hidden relative group-hover/proof:border-indigo-200 transition-colors">
                <img
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/proof:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                  <Link href={payment.receiptUrl} target="_blank">
                    <Button className="bg-white dark:bg-card text-gray-900 dark:text-foreground hover:bg-gray-100 rounded-xl h-11 px-8 font-bold uppercase text-[10px] tracking-widest shadow-2xl">
            ...
            <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm flex items-center justify-center py-20 group">
              <div className="text-center">
                <div className="h-16 w-16 rounded-2xl bg-gray-50 dark:bg-muted/10 flex items-center justify-center mx-auto mb-5 group-hover:bg-amber-50 transition-colors border border-gray-100 dark:border-border">
                  <AlertCircle className="h-8 w-8 text-gray-300 group-hover:text-amber-400 transition-colors" />
                </div>
                <h4 className="text-base font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">
                  No Receipt Attached
                </h4>
                <p className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest mt-2 max-w-[260px] leading-relaxed mx-auto">
                  This payment was submitted without an attached image.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm relative overflow-hidden group">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400 dark:text-muted-foreground mb-6 flex items-center gap-2">
              ...
              <div className="space-y-5 relative z-10">
                <div className="p-5 bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-600/20 group-hover:scale-[1.01] transition-transform duration-300">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-8 w-8 rounded-lg bg-white dark:bg-card/10 flex items-center justify-center">
                      <Home className="h-4 w-4 text-indigo-600" />
                    </div>
                    <div>
                      <p className="text-[9px] font-bold text-indigo-200 uppercase tracking-[0.2em]">
                        Hostel
                      </p>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-white/10">
                    ...
                    {payment.Booking?.Room?.floor && (
                      <Badge className="bg-white dark:bg-card/20 text-indigo-600 border-none rounded-lg px-2 py-0.5 text-[9px] font-bold uppercase transition-all">
        ...
        <div className="space-y-8">
          ...
          <div
            className={`rounded-2xl p-6 shadow-sm border ${payment.userBalance > 0 ? "bg-amber-50 border-amber-100 shadow-amber-200/20" : "bg-emerald-50 border-emerald-100 shadow-emerald-200/20"} transition-all duration-500`}
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div
                  className={`h-10 w-10 rounded-xl flex items-center justify-center ${payment.userBalance > 0 ? "bg-amber-100 text-amber-600" : "bg-emerald-100 text-emerald-600"}`}
                >
                  <Wallet className="h-5 w-5" />
                </div>
                <div className="flex flex-col">
                  <h4
                    className={`text-[10px] font-bold uppercase tracking-widest ${payment.userBalance > 0 ? "text-amber-800" : "text-emerald-800"}`}
                  >
                    Total Balance
                  </h4>
                  <p
                    className={`text-[9px] font-medium uppercase ${payment.userBalance > 0 ? "text-amber-600" : "text-emerald-600"}`}
                  >
                    Pending & Overdue
                  </p>
                </div>
              ...
              <div
                className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-tighter ${payment.userBalance > 0 ? "bg-amber-200/50 text-amber-900 border border-amber-200" : "bg-emerald-200/50 text-emerald-900 border border-emerald-200"}`}
              >
            ...
            <div className="flex items-baseline gap-1">
              <span
                className={`text-2xl font-black tracking-tight ${payment.userBalance > 0 ? "text-amber-900" : "text-emerald-900"}`}
              >
                PKR {payment.userBalance?.toLocaleString()}
              </span>
              <span
                className={`text-[10px] font-bold uppercase ${payment.userBalance > 0 ? "text-amber-600" : "text-emerald-600"}`}
              >
                due
              </span>
            </div>
            {payment.userBalance > (payment.amount || 0) && (
              <div className="mt-4 p-3 bg-white dark:bg-card/50 rounded-xl border border-amber-200/30">
                <p className="text-[10px] font-medium text-amber-700 leading-tight">
                  <AlertTriangle className="h-3 w-3 inline mr-1 mb-0.5" />
                  This student has other unpaid invoices totaling PKR{" "}
                  {(payment.userBalance - payment.amount).toLocaleString()}.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-indigo-600 text-white rounded-2xl p-8 shadow-2xl shadow-indigo-600/20 relative overflow-hidden group">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-[9px] font-bold text-indigo-300 uppercase block mb-2 tracking-widest">
                  Booking REF
                </span>
                {payment.bookingId ? (
                  <div className="flex items-center justify-between">
                    <p className="text-xl font-bold text-white tracking-tighter">
                      BK-{payment.bookingId?.slice(-8).toUpperCase()}
                    </p>
                    <Link href={`/admin/bookings/${payment.bookingId}`}>
                      <div className="h-7 w-7 rounded-lg bg-white dark:bg-card/10 flex items-center justify-center hover:bg-white dark:bg-card hover:text-indigo-600 transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-medium text-indigo-300 uppercase tracking-widest mt-1">
                      No specific booking linked
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 pt-4 border-t border-white/10">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-bold text-white">
                    {format(
                      new Date(payment.Booking?.checkIn || new Date()),
                      "dd MMM yy",
                    )}
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-bold text-emerald-300 uppercase tracking-tighter leading-none">
              ...
              {payment.bookingId && (
                <Link href={`/admin/bookings/${payment.bookingId}`}>
                  <Button className="w-full h-11 bg-white dark:bg-card/10 border border-white/20 hover:bg-white dark:bg-card hover:text-indigo-600 text-black font-bold text-[10px] uppercase tracking-widest rounded-xl transition-all mt-2 shadow-md">
          ...
          {/* Timeline */}
          <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm space-y-6 group/audit">
            <div className="flex items-center justify-between">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 dark:text-muted-foreground flex items-center gap-2">
