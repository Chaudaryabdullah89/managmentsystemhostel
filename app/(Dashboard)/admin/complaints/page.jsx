                ...
                <div className="p-7 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    {(complaint.status === "PENDING" || complaint.status === "IN_PROGRESS") && (
                        <div className="space-y-4 pt-2 border-t border-gray-100 dark:border-border">
                            <p className="text-[9px] font-black uppercase tracking-widest text-gray-400 dark:text-muted-foreground">Status</p>
                            <div className="space-y-2">
                                <Label className="text-[9px] font-black uppercase tracking-wider text-gray-400 dark:text-muted-foreground">Assign</Label>
                            ...
                            <div className="space-y-2">
                                <Label className="text-[9px] font-black uppercase tracking-wider text-gray-400 dark:text-muted-foreground">Details</Label>
                                <Textarea
                                    placeholder="Notes"
                                    value={notes}
                    ...
                    {/* Chat Thread */}
                    <div className="space-y-4 pt-2 border-t border-gray-100 dark:border-border">
                        <p className="text-[9px] font-black uppercase tracking-widest text-gray-400 dark:text-muted-foreground">Chat</p>
                        <div className="space-y-3 max-h-[240px] overflow-y-auto pr-1">
                            {complaint.comments?.length > 0 ? complaint.comments.map((c) => {
                                ...
                                <div className="text-center py-8 text-gray-400 dark:text-muted-foreground text-xs font-bold uppercase tracking-widest">Clear</div>
                            )}
                        </div>
                        <div className="flex items-center gap-2">
                            <Input
...
const ComplaintsPage = () => {
    ...
    if (isComplaintsLoading || isStatsLoading) return <ListPageSkeleton accentColor="bg-indigo-600" />;
                ...
                <div className="pt-4">
                    <div className="pt-4 px-2 md:px-0">
                        <div className="bg-indigo-600 text-white rounded-[2rem] p-5 md:p-4 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-indigo-600/20 relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-full bg-white dark:bg-card/5 skew-x-12 translate-x-20" />
                            <div className="flex items-center gap-4 md:gap-6 relative z-10 w-full md:w-auto px-2 md:px-4">
                                <div className="h-10 w-10 rounded-xl bg-white dark:bg-card/10 flex items-center justify-center backdrop-blur-md shrink-0">
                            ...
                            <div className="h-6 w-px bg-white dark:bg-card/10 hidden md:block" />
                            ...
                            <div className="flex items-center gap-3 md:pr-6 relative z-10 w-full md:w-auto justify-center md:justify-end border-t md:border-none border-white/10 pt-4 md:pt-0">
                                ...
                                <div className="h-2 w-2 rounded-full bg-white dark:bg-card animate-pulse shadow-[0_0_10px_rgba(255,255,255,0.4)]" />
                            </div>
                        </div>
                    </div>
                </div>
