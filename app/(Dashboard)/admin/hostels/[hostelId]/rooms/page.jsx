            ...
            <main className="max-w-[1600px] mx-auto px-4 md:px-6 py-8 space-y-8">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 px-1 md:px-0">
                    {[
                        ...
                        { label: 'Total Rent', value: `PKR ${rooms.reduce((acc, r) => acc + Number(r.monthlyrent || r.montlyrent || r.price || 0), 0).toLocaleString()}`, icon: Coins, color: 'text-emerald-600', bg: 'bg-emerald-50' },
