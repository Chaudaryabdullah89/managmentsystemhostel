...
import { ChevronDown, X, Save, ArrowLeft, Building2, LayoutGrid, Coins, Sparkle, ShieldCheck, Clock, Image as ImageIcon, Loader2 } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
                ...
                <div className="max-w-5xl mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-bold text-gray-900 tracking-tight leading-none">Modify Unit Config</h1>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none mt-1">Suite {roomNumber || '...'}</p>
                        </div>
                    </div>
                    <Button
                        ...
                        <Card className="border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] bg-white">
                            ...
                            <CardContent className="px-8 pb-8 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-50">
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Bed Capacity *</Label>
                                        <Input
                                            type="number"
                                            className="h-11 bg-white border-gray-100 rounded-xl font-bold text-gray-900 focus:ring-1 focus:ring-black"
                                            value={capacity}
