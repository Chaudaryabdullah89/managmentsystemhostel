        ...
        <div className="flex h-screen items-center justify-center bg-white dark:bg-card font-sans">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                    <p className="text-lg font-bold text-gray-900 dark:text-foreground tracking-tight">Compiling Property Analytics...</p>
                    <p className="text-xs text-gray-500 dark:text-muted-foreground font-medium mt-1 uppercase tracking-widest">Building Fiscal Models & Occupancy Deltas</p>
                </div>
            </div>
        </div>
    );
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-bold text-gray-900 dark:text-foreground tracking-tight uppercase">Audit: {hostel.name}</h1>
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-muted-foreground">Property Node</span>
                    ...
                    <div className="flex items-center gap-3">
                        <Select value={selectedPeriod} onValueChange={setSelectedPeriod}>
                            <SelectTrigger className="h-9 w-[140px] rounded-xl border-gray-200 dark:border-border bg-white dark:bg-card font-bold text-[10px] uppercase tracking-wider text-gray-600 dark:text-muted-foreground shadow-sm transition-all focus:ring-0">
                                <SelectValue />
                            </SelectTrigger>
            ...
            <main className="max-w-[1600px] mx-auto px-6 py-8 space-y-8">
                ...
                <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="space-y-1.5">
                            ...
                            <p className="text-xs font-bold text-gray-900 dark:text-foreground uppercase italic truncate">{hostel.address}</p>
                        </div>
                        <div className="space-y-1.5">
                            <span className="text-[9px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                                <ShieldCheck className="h-3 w-3" /> Personnel Authority
                            </span>
                            <p className="text-xs font-bold text-gray-900 dark:text-foreground uppercase italic truncate">{hostel.manager}</p>
                        </div>
                        <div className="space-y-1.5">
                            <span className="text-[9px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                                <Phone className="h-3 w-3" /> Contact Prime
                            </span>
                            <p className="text-xs font-bold text-gray-900 dark:text-foreground uppercase italic truncate">{hostel.phone}</p>
                        </div>
                        <div className="space-y-1.5">
                            <span className="text-[9px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                                <Calendar className="h-3 w-3" /> Registry Date
                            </span>
                            <p className="text-xs font-bold text-gray-900 dark:text-foreground uppercase italic truncate">{format(new Date(), 'MMM dd, yyyy')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={i} className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-all group">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[9px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest italic">{stat.label}</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <Card className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-3xl shadow-sm overflow-hidden">
                            <div className="p-8 border-b border-gray-50 bg-gray-50 dark:bg-muted/10/20 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="h-10 w-10 rounded-xl bg-black flex items-center justify-center text-white shadow-lg shadow-black/10">
                                        <BarChart3 className="h-5 w-5" />
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 dark:text-foreground uppercase tracking-tight italic">Fiscal Trajectory</h3>
                                        <p className="text-[9px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest mt-1 italic">6-Month property-level settlement log</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-6">
                        <Card className="bg-black text-white rounded-3xl p-8 relative overflow-hidden group shadow-xl">
                            <div className="absolute top-0 right-0 h-full w-24 bg-white dark:bg-card/5 skew-x-12 translate-x-10" />
                            <div className="flex items-center gap-4 mb-6 relative z-10">
                                ...
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground italic">Audit Summary</h4>
                            </div>
                            <div className="space-y-6 relative z-10">
                                <div className="flex justify-between items-end border-b border-white/10 pb-4">
                                    <div className="flex flex-col">
                                        <span className="text-[8px] font-black text-gray-500 dark:text-muted-foreground uppercase tracking-widest italic">Node Efficiency</span>
                                ...
                                <div className="flex justify-between items-end border-b border-white/10 pb-4">
                                    <div className="flex flex-col">
                                        <span className="text-[8px] font-black text-gray-500 dark:text-muted-foreground uppercase tracking-widest italic">Profit Vector</span>
                                ...
                                <Button className="w-full h-12 mt-4 bg-white dark:bg-card text-black font-black text-[10px] uppercase tracking-[0.2em] rounded-xl hover:bg-gray-200 transition-all flex items-center justify-center gap-3" onClick={() => router.push(`/admin/hostels/${hostelId}`)}>
                        ...
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-3xl p-8 shadow-sm">
                            <h4 className="text-[10px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-[0.2em] mb-6 italic">Fiscal Vectors</h4>
                            <div className="space-y-3">
                                {[
                                    ...
                                    <Button key={i} variant="outline" className="w-full h-12 rounded-xl border-gray-100 dark:border-border font-bold text-[9px] uppercase tracking-widest flex items-center justify-between px-4 hover:bg-black hover:text-white transition-all group" onClick={() => router.push(node.link)}>
                                        <div className="flex items-center">
                                            <node.icon className="h-3.5 w-3.5 mr-3 text-gray-400 dark:text-muted-foreground group-hover:text-white" /> {node.label}
                                        </div>
