...
const PaymentHistoryPage = () => {
    ...
    if (!booking) return <div className="p-8 text-center text-gray-400 dark:text-muted-foreground font-bold uppercase tracking-widest">Booking Not Found</div>;
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-background pb-20 font-sans tracking-tight">
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-bold text-gray-900 dark:text-foreground tracking-tight uppercase">Payment History</h1>
                            ...
                            <DialogContent className="max-w-md p-0 overflow-hidden rounded-3xl border-0 shadow-2xl">
                                ...
                                <div className="p-8 bg-white dark:bg-card space-y-6">
                                    <div className="space-y-1.5 text-center">
                                        <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-muted-foreground">Total Amount PKR</Label>
                        ...
                        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                            ...
                            <DialogContent className="max-w-md p-0 overflow-hidden rounded-3xl border-0 shadow-2xl">
                                <div className="bg-gray-950 p-8 text-white text-center">
                                    ...
                                    <p className="text-[10px] text-gray-500 dark:text-muted-foreground uppercase font-black tracking-widest">Record a New Payment</p>
                                </div>
                                <div className="p-8 bg-white dark:bg-card space-y-6">
                                    ...
                                    <Button className={`w-full h-12 ${duplicateWarning ? 'bg-rose-600 hover:bg-rose-700' : 'bg-black'} text-white font-black text-[10px] uppercase tracking-widest rounded-xl`} onClick={handleCreatePayment}>
                                        {duplicateWarning ? 'Commit Duplicate' : 'Save Payment'}
                                    </Button>
                                </div>
                            </DialogContent>
                        </Dialog>
            ...
            <main className="max-w-[1600px] mx-auto px-6 py-8 space-y-8">
                ...
                {/* Operations bar */}
                <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-2 flex items-center gap-4 shadow-sm">
                ...
                <div className="space-y-4">
                    {filteredPayments.length > 0 ? (
                        ...
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-3xl p-24 text-center border-dashed shadow-sm">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">No Payments Found</h3>
                        </div>
                    )}
                </div>
