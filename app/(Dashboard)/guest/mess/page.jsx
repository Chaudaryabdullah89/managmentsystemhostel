        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-muted/10/50 dark:bg-background flex flex-col items-center justify-center p-6">
                <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-3xl p-12 text-center max-w-md w-full shadow-sm">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 dark:text-foreground uppercase">No Hostel Assigned</h2>
                    <p className="text-gray-400 dark:text-muted-foreground text-sm mt-2">You are currently not assigned to any hostel. Please contact administration to view your mess schedule.</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-[1000px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-bold text-gray-900 dark:text-foreground tracking-tight uppercase">Weekly Mess Schedule</h1>
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-muted-foreground">Hostel Branch Active</span>
            ...
            <main className="max-w-[1000px] mx-auto px-6 py-8 space-y-8">
                ...
                <div>
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">Today's Schedule <span className="text-indigo-600">({today})</span></h3>
                    </div>
                                ...
                                <div className="p-8 hover:bg-amber-50/30 transition-colors">
                                    <div className="flex flex-col h-full justify-between">
                                        <div>
                                            ...
                                            <h4 className="text-lg font-black text-gray-900 dark:text-foreground uppercase tracking-tight mb-1">Breakfast</h4>
                                            ...
                                            <p className="text-base font-medium text-gray-700 dark:text-foreground leading-relaxed">
                                                {todaysMenu?.breakfast || <span className="text-gray-400 dark:text-muted-foreground italic font-normal">No items scheduled</span>}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 hover:bg-emerald-50/30 transition-colors">
                                    <div className="flex flex-col h-full justify-between">
                                        <div>
                                            ...
                                            <h4 className="text-lg font-black text-gray-900 dark:text-foreground uppercase tracking-tight mb-1">Lunch</h4>
                                            ...
                                            <p className="text-base font-medium text-gray-700 dark:text-foreground leading-relaxed">
                                                {todaysMenu?.lunch || <span className="text-gray-400 dark:text-muted-foreground italic font-normal">No items scheduled</span>}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 hover:bg-indigo-50/30 transition-colors">
                                    <div className="flex flex-col h-full justify-between">
                                        <div>
                                            ...
                                            <h4 className="text-lg font-black text-gray-900 dark:text-foreground uppercase tracking-tight mb-1">Dinner</h4>
                                            ...
                                            <p className="text-base font-medium text-gray-700 dark:text-foreground leading-relaxed">
                                                {todaysMenu?.dinner || <span className="text-gray-400 dark:text-muted-foreground italic font-normal">No items scheduled</span>}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="pt-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">Full Weekly Overview</h3>
                    </div>
                    ...
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        {otherDays.map((day) => {
                            ...
                            return (
                                <AccordionItem key={day} value={day} className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl px-6 py-2 shadow-sm data-[state=open]:border-indigo-200 data-[state=open]:ring-2 data-[state=open]:ring-indigo-50 transition-all">
                                    <AccordionTrigger className="hover:no-underline py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-bold text-gray-900 dark:text-foreground uppercase tracking-widest group-data-[state=open]:text-indigo-600 transition-colors flex-1 text-left">{day}</span>
                                        </div>
                                    </AccordionTrigger>
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold text-gray-500 dark:text-muted-foreground uppercase tracking-widest">Breakfast</span>
                                                    </div>
                                                </div>
                                                <div className="bg-gray-50 dark:bg-muted/10 p-4 rounded-xl border border-gray-100 dark:border-border/50">
                                                    <p className="text-sm font-medium text-gray-800 dark:text-foreground mb-3">{dayMenu?.breakfast || <span className="text-gray-400 dark:text-muted-foreground italic">Not defined</span>}</p>
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold text-gray-500 dark:text-muted-foreground uppercase tracking-widest">Lunch</span>
                                                    </div>
                                                </div>
                                                <div className="bg-gray-50 dark:bg-muted/10 p-4 rounded-xl border border-gray-100 dark:border-border/50">
                                                    <p className="text-sm font-medium text-gray-800 dark:text-foreground mb-3">{dayMenu?.lunch || <span className="text-gray-400 dark:text-muted-foreground italic">Not defined</span>}</p>
                                                    <div className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-500 dark:text-muted-foreground uppercase tracking-wider">
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold text-gray-500 dark:text-muted-foreground uppercase tracking-widest">Dinner</span>
                                                    </div>
                                                </div>
                                                <div className="bg-gray-50 dark:bg-muted/10 p-4 rounded-xl border border-gray-100 dark:border-border/50">
                                                    <p className="text-sm font-medium text-gray-800 dark:text-foreground mb-3">{dayMenu?.dinner || <span className="text-gray-400 dark:text-muted-foreground italic">Not defined</span>}</p>
                                                    <div className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-500 dark:text-muted-foreground uppercase tracking-wider">
