                ...
                <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-black text-gray-900 dark:text-foreground uppercase tracking-widest leading-none">Laundry Log</h1>
                        ...
                        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                            ...
                            <DialogContent className="rounded-3xl p-0 overflow-hidden max-w-sm border-none shadow-2xl">
                                <div className="bg-gray-900 p-6 text-white text-center">
                                    ...
                                    <p className="text-[10px] text-gray-400 dark:text-muted-foreground mt-1 uppercase font-black tracking-widest leading-none">Record laundry items</p>
                                </div>
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-muted-foreground ml-1">Number of items</label>
                                        <Input
                                            type="number" min="1"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            {filteredDue.length > 0 ? filteredDue.map((room) => (
                                ...
                                <div className="col-span-full py-20 flex flex-col items-center justify-center bg-white dark:bg-card border border-dashed border-gray-100 dark:border-border rounded-[3rem]">
                                    ...
                                    <h3 className="text-sm font-black text-gray-900 dark:text-foreground uppercase tracking-[0.2em]">All Clear!</h3>
                                    <p className="text-[10px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest mt-2 px-6 text-center">Every room laundry is complete</p>
                                </div>
                            )}
                        </div>
                    </TabsContent>
                    ...
                    <TabsContent value="registry" className="space-y-4">
                        <div className="space-y-3">
                            {filteredLogs.length > 0 ? filteredLogs.map((log) => (
                                <Card key={log.id} className="p-5 border-none shadow-sm rounded-3xl flex items-center justify-between group transition-all hover:shadow-xl bg-white dark:bg-card relative overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-5 flex-1">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <p className="text-[11px] font-medium text-gray-500 dark:text-muted-foreground line-clamp-1 italic">{log.notes || "Laundry complete."}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-10">
                                        <div className="flex flex-col items-end">
                                            ...
                                            <span className="text-[11px] font-black text-gray-900 dark:text-foreground uppercase whitespace-nowrap">{format(new Date(log.receivedAt), 'MMM dd, yyyy')}</span>
                                        </div>
                                        <div className="flex flex-col items-end">
                                            <span className="text-[9px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest">Time</span>
                                            <span className="text-[11px] font-black text-gray-900 dark:text-foreground uppercase whitespace-nowrap">{format(new Date(log.receivedAt), 'HH:mm')}</span>
                                        </div>
                                    </div>
                                </Card>
                            )) : (
                                <div className="col-span-full py-20 flex flex-col items-center justify-center bg-white dark:bg-card border border-dashed border-gray-100 dark:border-border rounded-[3rem]">
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-widest mt-2 px-6 text-center">New laundry logs will appear here</p>
                                </div>
                            )}
                        </div>
                    </TabsContent>
