...
const BookingDetailsPage = () => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-muted/10/30 font-sans">
        <div className="text-center space-y-6 max-w-md p-10 bg-white dark:bg-card rounded-[2.5rem] shadow-2xl shadow-black/5 border border-gray-100 dark:border-border">
          ...
          <Button
            ...
            className="h-12 px-8 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-[10px] uppercase tracking-wider w-full shadow-lg shadow-indigo-100"
          >
            Back to Bookings
          </Button>
        </div>
  ...
  if (!booking)
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-20 text-center font-sans tracking-tight">
              ...
              {[
                {
                  ...
                  bg: "bg-purple-50",
                  link: `/warden/rooms/${booking.Room?.id}/laundry`,
                },
                {
                  icon: Wrench,
                  label: "Maintenance",
                  ...
                  bg: "bg-amber-50",
                  link: `/warden/rooms/${booking.Room?.id}/maintenance`,
                },
                {
                  icon: Sparkle,
                  label: "Cleaning",
                  ...
                  color: "text-blue-500",
                  bg: "bg-blue-50",
                  link: `/warden/rooms/${booking.Room?.id}/cleaning`,
                },
              ].map((service, i) => (
                <div
                  key={i}
