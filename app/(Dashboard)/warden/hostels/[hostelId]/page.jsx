...
const HostelOverviewPage = () => {
  ...
  React.useEffect(() => {
    if (isWarden && user?.hostelId && hostelId !== user.hostelId) {
      router.replace(`/warden/hostels/${user.hostelId}`);
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-background font-sans">
        <div className="text-center space-y-4">
          ...
          <Button
            onClick={() => router.push("/warden/hostels")}
            variant="outline"
            ...
            <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl shadow-sm overflow-hidden">
              <div className="px-6 md:px-8 py-6 border-b border-gray-50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push("/warden/rooms/create")
                  }
                >
                  Add New Room
                </Button>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  bg: "bg-indigo-50",
                  link: `/warden/hostels/${hostelId}/email-settings`,
                },
              ].map((node, i) => (
                <div
                  key={i}
