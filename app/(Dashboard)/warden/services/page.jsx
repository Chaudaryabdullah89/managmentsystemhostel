...
const UnifiedServicesPage = () => {
    ...
    if (isLoading) {
        return (
            <div className="flex h-[100dvh] items-center justify-center bg-white dark:bg-card font-sans">
                <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col items-center gap-1.5 text-center px-4">
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-900 dark:text-foreground">Loading</p>
                        <p className="text-[8px] font-bold uppercase tracking-widest text-gray-400 dark:text-muted-foreground italic">Waiting...</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="max-w-[1600px] mx-auto px-4 md:px-6 h-full flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
                        ...
                        <div className="flex flex-col min-w-0">
                            <h1 className="text-sm md:text-lg font-bold text-gray-900 dark:text-foreground tracking-tight uppercase truncate">Services</h1>
                            <div className="flex items-center gap-1.5 md:gap-2">
                                <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-muted-foreground">Status</span>
                    ...
                    <div className="flex items-center gap-2 md:gap-3 shrink-0">
                        <Button
                            variant="outline"
                            className="h-8 md:h-10 px-2.5 md:px-5 rounded-xl border-gray-200 dark:border-border bg-white dark:bg-card font-bold text-[9px] md:text-[10px] uppercase tracking-wider text-gray-600 dark:text-muted-foreground hover:bg-gray-50 dark:hover:bg-muted/5 dark:bg-muted/10 transition-all shadow-sm shrink-0"
                            onClick={handleSync}
                        >
                            <RefreshCw className="h-3.5 w-3.5 md:mr-2 text-gray-400 dark:text-muted-foreground" />
                            <span className="hidden sm:inline">Sync</span>
                            <span className="sm:hidden">Sync</span>
                        </Button>
                        <Button onClick={refetchAll} variant="outline" size="icon" className="h-8 w-8 md:h-10 md:w-10 rounded-xl border-gray-200 dark:border-border bg-white dark:bg-card shrink-0 sm:flex hidden">
                            <RefreshCw className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-400 dark:text-muted-foreground" />
                        </Button>
                    </div>
                </div>
            </div>
            ...
            <main className="max-w-[1600px] mx-auto px-4 md:px-6 py-6 md:py-10 space-y-6 md:space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    {[
                        ...
                        <div key={i} className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-[2rem] p-5 md:p-6 shadow-sm hover:shadow-md transition-all group relative overflow-hidden flex-1 min-w-0">
                            <div className="absolute top-0 right-0 w-24 h-full bg-gray-50 dark:bg-muted/10/50 dark:bg-background skew-x-12 translate-x-10 group-hover:translate-x-8 transition-transform" />
                            <div className="flex items-center gap-5 md:gap-6 relative z-10">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <span className="text-[9px] md:text-[10px] font-black text-gray-400 dark:text-muted-foreground uppercase tracking-[0.2em] truncate">{stat.label}</span>
                                    <div className="flex items-baseline gap-2 mt-1 truncate">
                                        <span className="text-2xl md:text-3xl font-black text-gray-900 dark:text-foreground tracking-tighter leading-none">{stat.value}</span>
                                        <span className="text-[8px] md:text-[9px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest truncate">{stat.sub}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <Tabs defaultValue="operational-tasks" className="space-y-6 md:space-y-8">
                    <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4">
                        <TabsList className="bg-white dark:bg-card p-1 rounded-xl md:rounded-2xl border border-gray-100 dark:border-border h-11 md:h-14 flex shadow-sm overflow-x-auto scrollbar-hide shrink-0 min-w-0">
                        ...
                        <div className="relative w-full lg:w-72 group">
                            <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-3.5 w-3.5 md:h-4 md:w-4 text-gray-400 dark:text-muted-foreground group-focus-within:text-blue-600 transition-colors" />
                            <Input
                                placeholder="SEARCH..."
                                className="pl-10 md:pl-12 h-11 md:h-14 rounded-xl md:rounded-[1.25rem] border-gray-100 dark:border-border bg-white dark:bg-card shadow-sm focus:ring-blue-500 transition-all text-[10px] md:text-[11px] font-black uppercase tracking-widest placeholder:text-gray-300"
                                value={searchQuery}
                    ...
                    <TabsContent value="operational-tasks" className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            {allPendingTasks.length === 0 && (
                                <div className="col-span-full py-24 bg-white dark:bg-card border border-dashed border-gray-200 dark:border-border rounded-[3rem] text-center space-y-4">
                                    <Sparkles className="h-16 w-16 text-gray-100 mx-auto" />
                                    <div>
                                        <p className="text-lg font-bold text-gray-900 dark:text-foreground uppercase">Clear</p>
                                        <p className="text-xs text-gray-400 dark:text-muted-foreground font-bold uppercase tracking-widest">No active tasks found</p>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    <TabsContent value="due-alerts" className="space-y-6">
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-[3.5rem] overflow-hidden shadow-sm">
                            <div className="p-10 border-b border-gray-50 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 bg-gray-50 dark:bg-muted/10/30">
                                <div className="space-y-1">
                                    <h3 className="text-lg font-bold text-gray-900 dark:text-foreground uppercase tracking-tight">Suggestions</h3>
                                    <p className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest">Suggestions based on last service time</p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 divide-x divide-gray-100">
                                <div className="p-10 space-y-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h4 className="text-sm font-bold uppercase tracking-widest text-gray-900 dark:text-foreground">Cleaning</h4>
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        {dueServices?.dueCleaning?.length === 0 && (
                                            <div className="py-8 text-center bg-gray-50 dark:bg-muted/10/50 dark:bg-background rounded-3xl">
                                                <p className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest">All Clean</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                <div className="p-10 space-y-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h4 className="text-sm font-bold uppercase tracking-widest text-gray-900 dark:text-foreground">Laundry</h4>
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        {dueServices?.dueLaundry?.length === 0 && (
                                            <div className="py-8 text-center bg-gray-50 dark:bg-muted/10/50 dark:bg-background rounded-3xl">
                                                <p className="text-[10px] font-bold text-gray-400 dark:text-muted-foreground uppercase tracking-widest">All Good</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                    ...
                    <TabsContent value="history" className="space-y-6">
                        <div className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-[3rem] overflow-hidden shadow-sm">
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-50 dark:bg-muted/10/50 dark:bg-background">
                                    <tr>
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">Type</th>
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">Room</th>
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">Date</th>
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground">Status</th>
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-muted-foreground text-right">Notes</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-50 dark:divide-border/20">
                                    ...
                                    ...(laundryLogs || []).map(l => ({ ...l, type: 'Laundry' }))]
                                        ...
                                        .slice(0, 30)
                                        .map((log, i) => (
                                            <tr key={i} className="hover:bg-gray-50 dark:hover:bg-muted/5 dark:bg-muted/10/50 dark:bg-background transition-colors group">
                                                <td className="px-8 py-5">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="text-[11px] font-bold text-gray-900 dark:text-foreground uppercase">{log.type}</span>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-5">
                                                    <span className="text-[11px] font-bold text-gray-700 dark:text-foreground">Room {log.Room?.roomNumber}</span>
                                                </td>
                                                <td className="px-8 py-5">
                                                    <span className="text-[10px] font-medium text-gray-500 dark:text-muted-foreground">{format(new Date(log.performedAt || log.createdAt || log.receivedAt), 'MMM dd, HH:mm')}</span>
                                                </td>
                                                <td className="px-8 py-5">
                                                ...
                                                <td className="px-8 py-5 text-right">
                                                    <span className="text-[9px] font-bold text-gray-400 dark:text-muted-foreground uppercase italic truncate max-w-[200px] inline-block">
...
const TaskCard = ({ data, refetch }) => {
    ...
    return (
        <Card className="rounded-[2.5rem] border-gray-100 dark:border-border shadow-sm hover:shadow-lg hover:border-blue-600/20 transition-all p-6 bg-white dark:bg-card group overflow-hidden relative">
            ...
            <div className="space-y-6 relative z-10">
                ...
                <div>
                    <div className="flex items-baseline gap-2">
                        <span className="text-lg font-bold text-gray-900 dark:text-foreground tracking-tight uppercase">Room {data.Room?.roomNumber}</span>
                        <span className={`text-[8px] font-bold uppercase tracking-widest ${data.taskType === 'cleaning' ? 'text-amber-500' : 'text-blue-500'}`}>
                            {data.taskType}
                        </span>
                    </div>
                    <p className="text-[10px] text-gray-400 dark:text-muted-foreground font-bold uppercase tracking-widest mt-1">Added {formatDistanceToNow(new Date(data.createdAt))} ago</p>
                </div>
                ...
                <div className="flex items-center gap-2 pt-2">
                    {data.taskType === 'laundry' && data.status === 'PENDING' && (
                        <Button
                            variant="outline"
                            className="flex-1 h-10 rounded-xl text-[10px] font-bold uppercase tracking-wider border-gray-200 dark:border-border hover:bg-gray-50 dark:hover:bg-muted/5 dark:bg-muted/10 disabled:opacity-50"
...
const DueItem = ({ room, type, refetch }) => {
    ...
    return (
        <div className="flex items-center justify-between group p-5 rounded-[2rem] bg-gray-50 dark:bg-muted/10/50 dark:bg-background hover:bg-white dark:bg-card transition-all border border-transparent hover:border-gray-100 dark:border-border hover:shadow-sm">
            <div className="flex items-center gap-4">
                <div className="h-10 w-10 rounded-2xl bg-white dark:bg-card border border-gray-100 dark:border-border flex items-center justify-center text-gray-400 dark:text-muted-foreground group-hover:text-blue-600 group-hover:border-blue-100 transition-colors shadow-sm">
                    <Bed className="h-5 w-5" />
                </div>
                <div className="flex flex-col">
                    <span className="text-[12px] font-bold text-gray-900 dark:text-foreground uppercase">Room {room.roomNumber}</span>
            ...
            <Button
                variant="ghost"
                size="sm"
                className="h-9 px-4 rounded-xl text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-muted-foreground hover:text-blue-600 hover:bg-blue-50"
