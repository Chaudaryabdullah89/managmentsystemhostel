...
const WardenDashboard = () => {
    ...
    const hostels = reportData?.hostelPerformance || (hostelInfo ? [{
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="flex items-center justify-between px-2">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900 dark:text-foreground">Hostel Overview</h3>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 lg:grid-cols-2 gap-3 md:gap-4 px-2 md:px-0">
                                {[
                                    ...
                                    ...(hasAnyExpensePermission ? [{ label: 'Expenses', icon: Receipt, href: '/warden/expenses', color: 'text-blue-600', bg: 'bg-blue-50' }] : []),
                                    { label: 'Residents', icon: Users, href: '/warden/residents', color: 'text-purple-600', bg: 'bg-purple-50' },
