                ...
                <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-bold text-gray-900 tracking-tight uppercase">Warden Dashboard</h1>
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Hostel Overview</span>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="flex items-center justify-between px-2">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900">Your Hostel</h3>
                            </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-50/50">
                                    <tr>
                                        ...
                                        <th className="px-8 py-5 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400">Total Revenue</th>
                            ...
                            <Card className="rounded-[2.5rem] border-gray-100 shadow-sm overflow-hidden group">
                                <CardHeader className="bg-gray-50/50 p-6 flex flex-row items-center justify-between border-b border-gray-50">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <CardTitle className="text-[11px] font-bold uppercase tracking-widest text-gray-900">Urgent Complaints</CardTitle>
                                    </div>
                                ...
                                <CardContent className="p-6">
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Total Complaints</span>
                                            <span className="text-base font-bold text-gray-900">{complaintStats.total}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Pending Resolution</span>
                            ...
                            <Card className="rounded-[2.5rem] border-gray-100 shadow-sm overflow-hidden group">
                                <CardHeader className="bg-gray-50/50 p-6 flex flex-row items-center justify-between border-b border-gray-50">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <CardTitle className="text-[11px] font-bold uppercase tracking-widest text-gray-900">Hostel Status</CardTitle>
                                    </div>
                                ...
                                <CardContent className="p-6">
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Rooms Available</span>
                                            <span className="text-base font-bold text-emerald-600">{hostelData[0]?.rooms || 0}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 px-2">
                                <div className="h-5 w-1 bg-blue-600 rounded-full" />
                                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900">Quick Actions</h3>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 px-2">
                                <div className="h-5 w-1 bg-blue-600 rounded-full" />
                                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900">Recent Payments</h3>
                            </div>
                            <div className="bg-white border border-gray-100 rounded-[2.5rem] p-6 shadow-sm space-y-6">
                                {recentPayments?.payments?.length > 0 ? recentPayments.payments.slice(0, 4).map((pmt) => (
                                    ...
                                    <div className="py-10 text-center">
                                        ...
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">No recent payments found</p>
                                    </div>
                                )}
