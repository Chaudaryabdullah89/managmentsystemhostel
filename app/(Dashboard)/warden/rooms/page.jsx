...
const RoomsContent = ({ params: paramsPromise }) => {
    ...
    if (roomsLoading || hostelLoading) return <Loader label="Loading" subLabel="Getting records..." icon={Building2} fullScreen={false} />;
                ...
                <div className="max-w-[1600px] mx-auto px-4 md:px-6 h-full flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-0">
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="flex flex-col min-w-0">
                            <h1 className="text-sm md:text-lg font-bold text-gray-900 tracking-tight truncate">{hostel?.name || 'Rooms'}</h1>
            ...
            <main className="max-w-[1600px] mx-auto px-6 py-8 space-y-8">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 px-1 md:px-0">
                    {[
                        ...
                        { label: 'Rent', value: `PKR ${rooms.reduce((acc, r) => acc + (r.monthlyrent || r.montlyrent || r.price || 0), 0).toLocaleString()}`, icon: Coins, color: 'text-emerald-600', bg: 'bg-emerald-50' },
                ...
                <div className="space-y-3">
                    {filteredRooms.length > 0 ? (
                            ...
                            <div key={room.id || index} className="bg-white border border-gray-100 rounded-2xl flex flex-col items-stretch shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="flex items-center gap-5 min-w-0 flex-1 lg:flex-none lg:min-w-[280px]">
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <div className="flex items-center gap-3">
                                                <h3 className="text-sm md:text-base font-black text-gray-900 uppercase tracking-tight truncate">Room_{room.roomNumber}</h3>
                                            ...
                                            <div className="flex items-center gap-1.5 mt-0.5">
                                                ...
                                                <span className="text-[9px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest truncate">FLOOR {room.floor} • {room.type} TYPE</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-gray-50/30 border-t border-gray-100 px-5 md:px-6 py-3 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
                                    <div className="flex items-center gap-2 shrink-0">
                                        ...
                                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Included</span>
                                    </div>
                        ...
                        <div className="py-20 flex flex-col items-center justify-center bg-white border border-gray-100 rounded-3xl shadow-sm border-dashed mx-4">
                            ...
                            <h3 className="text-base font-black text-gray-900 uppercase tracking-tight">Empty</h3>
                            <p className="text-gray-400 font-black uppercase tracking-widest text-[9px] mt-1">Try changing your filters.</p>
                            <Button
                                variant="outline"
        ...
        <Suspense fallback={
            <div className="flex h-screen items-center justify-center bg-white font-sans">
                <div className="flex flex-col items-center gap-6">
                    ...
                    <p className="text-lg font-bold text-gray-900 tracking-tight">Loading</p>
                </div>
            </div>
        }>
            <RoomsContent {...props} />
