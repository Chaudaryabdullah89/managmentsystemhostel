...
const CreateRoomForm = () => {
    ...
    if (hostelsLoading) return (
        <div className="min-h-screen bg-gray-50 dark:bg-background flex flex-col items-center justify-center font-sans tracking-tight">
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-background font-sans tracking-tight">
            {/* Synced Header */}
                            ...
                            <div className="p-6 space-y-5">
                                <div className="space-y-1.5 flex flex-col">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input type="number" className="pl-14 h-11 bg-gray-50 dark:bg-background border-gray-100 dark:border-border rounded-2xl font-black text-lg text-center focus:bg-white dark:bg-card transition-all shadow-none" value={price} onChange={(e) => setPrice(e.target.value)} />
                                    </div>
                                </div>
                                <div className="space-y-1.5 flex flex-col">
