...
const WardenCleaningPage = () => {
    ...
    if (logsLoading || dueLoading) return <Loader label="Cleaning" subLabel="Loading..." icon={Activity} />;
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-lg font-black text-gray-900 uppercase tracking-widest leading-none">Cleaning Log</h1>
                        ...
                        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                            ...
                            <DialogContent className="rounded-3xl p-0 overflow-hidden max-w-sm border-none shadow-2xl">
                                <div className="bg-gray-900 p-6 text-white text-center">
                                    ...
                                    <p className="text-[10px] text-gray-400 mt-1 uppercase font-black tracking-widest">Record cleaning session</p>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            {filteredDue.length > 0 ? filteredDue.map((room) => (
                                ...
                                <div className="col-span-full py-20 flex flex-col items-center justify-center bg-white border border-dashed border-gray-100 rounded-[3rem]">
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-2 px-6 text-center">Every room is currently clean</p>
                                </div>
                            )}
                        </div>
                    </TabsContent>
                    ...
                    <TabsContent value="registry" className="space-y-4">
                        <div className="space-y-3">
                            {filteredLogs.length > 0 ? filteredLogs.map((log) => (
                                <Card key={log.id} className="p-5 border-none shadow-sm rounded-3xl flex items-center justify-between group transition-all hover:shadow-xl bg-white relative overflow-hidden transition-all">
                                    ...
                                    <div className="flex items-center gap-5 flex-1">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <p className="text-[11px] font-medium text-gray-500 line-clamp-1 italic">{log.notes || "Standard cleaning done."}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-10">
                                        <div className="flex flex-col items-end">
                                            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Date</span>
                                            <span className="text-[11px] font-black text-gray-900 uppercase whitespace-nowrap">{format(new Date(log.performedAt), 'MMM dd, yyyy')}</span>
                                        </div>
                                        <div className="flex flex-col items-end">
                                            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Time</span>
                                            <span className="text-[11px] font-black text-gray-900 uppercase whitespace-nowrap">{format(new Date(log.performedAt), 'HH:mm')}</span>
                                        </div>
                                    </div>
                                </Card>
                            )) : (
                                <div className="col-span-full py-20 flex flex-col items-center justify-center bg-white border border-dashed border-gray-100 rounded-[3rem]">
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-2 px-6 text-center">New cleaning logs will appear here</p>
                                </div>
                            )}
                        </div>
                    </TabsContent>
