...
/** Dashboard-level error boundary (catches errors inside all dashboard pages) */
            ...
            <div className="max-w-md w-full bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-rose-900/5 text-center space-y-8 animate-in slide-in-from-bottom-8 duration-500 fade-in">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-sm font-medium text-gray-500">
                        A dashboard error occurred. Our system has logged this issue automatically.
                    </p>
                </div>

                <div className="p-4 bg-rose-50 rounded-2xl border border-rose-100 text-left overflow-hidden">
                    <p className="text-[10px] font-mono text-rose-600 font-bold truncate">
                        ERR: {error?.message || "Unknown Dashboard Exception"}
                    </p>
                </div>
